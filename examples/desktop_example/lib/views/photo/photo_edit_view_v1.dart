...
class PhotoEditViewV1 extends StatefulWidget {
  const PhotoEditViewV1({
    Key? key,
    required this.photo,
  ...
  @override
  State<PhotoEditViewV1> createState() => PhotoEditViewV1State();
}

class PhotoEditViewV1State extends State<PhotoEditViewV1> {
